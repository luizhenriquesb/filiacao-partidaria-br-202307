...
Abaixo temos uma tabela com o total de pessoas filiadas atualmente no Brasil. Cabe lembrar que todos os dados desta análise fazem referência ap mês de julho de 2023.
...
Para visualizar essa informação, é melhor verificar a *proporção* de filiados em relação ao total de eleitores do Estado, pois, caso contrário, naturalmente os estados com mais eleitores apresentariam a maior quantidade de filiados.
...
dados_eleitorado_total |>
  ...
  labs(
    x = "",
    y = "Total",
    title = "Proporção de pessoas filiadas por Estado",
    subtitle = "Em relação ao total de eleitores do Estado",
    caption = "Fonte: Portal de Dados Abertos do TSE (ultima atualização: 07/2023)") +
...
Para ajudar na visualização de quais Estado (e regiões) do Brasil a proporção de pessoas filiadas é maior ou menor, apresentamos um mapa.
...
O mapa acima permite visualizar com mais facilidade quais Estados e regiões do Brasil possuem a maior proporção de pessoas filiadas em relação ao total de eleitores do Estado. Facilmente identificamos, por exemplo, que Tocantins e Amapá são os Estados com a maior proporção.
