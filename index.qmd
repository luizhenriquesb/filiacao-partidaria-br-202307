...
O mapa acima permite visualizar com mais facilidade quais Estados e regiões do Brasil possuem a maior proporção de pessoas filiadas em relação à população total. Facilmente identificamos, por exemplo, que Tocantins e Amapá são os Estados com a maior proporção.
